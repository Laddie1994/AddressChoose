package com.example.chooselibrary.db.manager;
...
import com.example.chooselibrary.db.AssetsDatabaseManager;
import com.example.chooselibrary.db.TableField;
import com.example.chooselibrary.module.AddressEntity;

import java.util.ArrayList;
import java.util.List;

import static com.example.chooselibrary.db.TableField.ADDRESS_DICT_FIELD_CODE;
import static com.example.chooselibrary.db.TableField.ADDRESS_DICT_FIELD_ID;
import static com.example.chooselibrary.db.TableField.ADDRESS_DICT_FIELD_PARENTID;
...
public class AddressDictManager {
     ...
     * @param adress
     */
    public void inserddress(AddressEntity adress){
        if(adress !=null){
    ...
    //更新地址
    public void updateAddressInfo(AddressEntity adress){
        if(adress !=null){
            db.beginTransaction();//手动设置开启事务
            try{
                ContentValues values = new ContentValues();
    ...
    public List<AddressEntity> getAddressList(){
        ...
        while (cursor.moveToNext()){
            AddressEntity adressInfo =  new AddressEntity();
    ...
    public List<AddressEntity> getProvinceList(){
        List<AddressEntity> provinceList = new ArrayList<>();
        ...
        while (cursor.moveToNext()){
            AddressEntity province =  new AddressEntity();
     ...
     * @param provinceCode
     */
    public AddressEntity getProvinceBean(String provinceCode){
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ ADDRESS_DICT_FIELD_CODE+"=?", new String[]{provinceCode});
        if(cursor!=null && cursor.moveToFirst()){
            AddressEntity province =  new AddressEntity();
            province.id = cursor.getInt(cursor.getColumnIndex(ADDRESS_DICT_FIELD_ID));
     ...
     * @return
     */
    public List<AddressEntity> getCityList(int  provinceId){
        List<AddressEntity> cityList = new ArrayList<>();
        ...
        while (cursor.moveToNext()){
            AddressEntity city =  new AddressEntity();
     ...
     * @return
     */
    public AddressEntity getCityBean(String cityCode){
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ ADDRESS_DICT_FIELD_CODE+"=?", new String[]{cityCode});
        if(cursor!=null && cursor.moveToFirst()){
            AddressEntity city =  new AddressEntity();
            city.id = cursor.getInt(cursor.getColumnIndex(ADDRESS_DICT_FIELD_ID));
     ...
     * @return
     */
    public List<AddressEntity> getCountyList(int cityId){
        List<AddressEntity> countyList = new ArrayList<>();
        ...
        while (cursor.moveToNext()){
            AddressEntity county = new AddressEntity();
    ...
    public AddressEntity getCountyBean(String countyCode){
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ ADDRESS_DICT_FIELD_CODE+"=?", new String[]{countyCode});
        if(cursor!=null && cursor.moveToFirst()){
            AddressEntity county = new AddressEntity();
            county.id = cursor.getInt(cursor.getColumnIndex(ADDRESS_DICT_FIELD_ID));
     ...
     * @return
     */
    public List<AddressEntity> getStreetList(int countyId){
        List<AddressEntity> streetList = new ArrayList<>();
        ...
        while (cursor.moveToNext()){
            AddressEntity street = new AddressEntity();
    ...
    public AddressEntity getStreetBean(String streetCode){
        Cursor cursor = db.rawQuery("select * from " + TableField.TABLE_ADDRESS_DICT+" where "+ ADDRESS_DICT_FIELD_CODE+"=?", new String[]{streetCode});
        if(cursor!=null && cursor.moveToFirst()){
            AddressEntity street = new AddressEntity();
            street.id = cursor.getInt(cursor.getColumnIndex(ADDRESS_DICT_FIELD_ID));
     ...
     * @return
     */
    public int isExist(AddressEntity bannerInfo){
        int count = 0;
